"""Slide-level stratified split for Phase 2 (20-WSI) validation batch — intermediate working split, not the official one."""
from sklearn.model_selection import train_test_split

def make_phase2_split(cache, val_frac=0.25, seed=42):
    seen, labels = [], []
